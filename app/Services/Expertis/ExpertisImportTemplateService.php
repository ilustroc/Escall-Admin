    ...
    public function asignaciones(): StreamedResponse
    {
        return $this->download(
            ...
            [
                ...
                [
                    '202607', 'EXPERTIS', '20123456789', 'CLIENTE FICTICIO DOS',
                    '20123456789-PRO', 'PRO', 'COSECHA 2025', 'TRAMO A',
                    'PRÉSTAMO', 'CONSUMO', '-', 'LIMA', 1500, 900,
                    '-', 12.5, '1988-10-03', 37, 2, 'SÍ', 1800,
                    'DEPENDIENTE', 2020, 'M', '1500 A 2000', 2022,
                ],
                [
                    '202607', 'EXPERTIS', 'CE000003', 'CLIENTE FICTICIO TRES',
                    'CE000003-CREDINKA', 'CREDINKA', '-', '-', 'CRÉDITO',
